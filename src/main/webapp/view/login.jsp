...
<style>
    ...
    .success-message {
        ...
        margin-bottom: 20px; /* Add margin below the success message */
    }
    h1 {
...
<<div class="container">
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <c:if test="${'true'.equals(param.signupSuccess)}">
            ...
            <div id="formFooter">
                <a class="underlineHover" href="${pageContext.request.contextPath}/signup.do">Sign Up</a>
                </div>
            <div id="formFooter">

            <a class="underlineHover" href="${pageContext.request.contextPath}/forgotPass.do">Forgot Password?</a>
            </div>
        </div>
    </div>
</div>
